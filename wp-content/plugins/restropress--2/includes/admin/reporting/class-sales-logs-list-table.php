...
class RPRESS_Sales_Log_Table extends WP_List_Table {
	...
	public function column_default( $item, $column_name ) {
		...
		switch ( $column_name ){
			...
			case 'customer' :
				$return = '<a href="' . admin_url( 'admin.php?page=rpress-customers&view=overview&id=' . absint( $item['customer']->id ) ) . '">' . $item['customer']->name . '</a>';
				break;
			...
			case 'payment_id' :
				$return = '<a href="' . admin_url( 'admin.php?page=rpress-payment-history&view=view-order-details&id=' . $item['payment_id'] ) . '">' . rpress_get_payment_number( $item['payment_id'] ) . '</a>';
				break;
