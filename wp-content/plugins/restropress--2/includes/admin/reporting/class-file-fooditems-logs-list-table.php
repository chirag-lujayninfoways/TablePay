...
class RPRESS_File_RestroPress_Log_Table extends WP_List_Table {
	...
	public function column_default( $item, $column_name ) {
		...
		switch ( $column_name ) {
			...
			case 'payment_id' :
				return $item['payment_id'] !== false ? '<a href="' . admin_url( 'admin.php?page=rpress-payment-history&view=view-order-details&id=' . $item['payment_id'] ) . '">' . rpress_get_payment_number( $item['payment_id'] ) . '</a>' : '';
			case 'ip' :
