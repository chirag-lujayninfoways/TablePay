		...
		<fieldset id="rpress_checkout_login_register" class="rpress-checkout-account-wrap rpress-checkout-block">
			...
			<div class="rpress-checkout-button-actions">
				<div class="rp-col-md-4 rp-col-lg-4 rp-col-sm-6">
					...
					<a href="<?php echo esc_url( add_query_arg( 'login', 1 ) ); ?>" class="rpress_checkout_register_login rpress-submit button <?php echo $color; ?> rp-col-sm-12" data-action="checkout_login"><?php _e( 'Login', 'restropress' ); ?></a>
				</div>
				<div class="rp-col-md-8 rp-col-sm-6">
					<span><?php echo sprintf( __( 'New to %s?', 'restropress' ), get_bloginfo( 'name' ) ); ?></span>
					<a href="<?php echo esc_url( remove_query_arg('login') ); ?>" class="rpress_checkout_register_login rpress-submit button <?php echo $color; ?>" data-action="checkout_register">
...
function rpress_get_checkout_button_purchase_label() {
	...
	if ( rpress_get_cart_total() ) {
		$complete_purchase = __( 'Place Order', 'restropress' );
	}

	return apply_filters( 'rpress_get_checkout_button_purchase_label', $complete_purchase );
}
