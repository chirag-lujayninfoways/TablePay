...
function rpress_logs_view_file_fooditems() {
	...
	<div class="wrap">
		...
		<form id="rpress-logs-filter" method="get" action="<?php echo admin_url( 'admin.php?page=rpress-reports&tab=logs' ); ?>">
			<?php
...
function rpress_log_views() {
	...
	?>
	<form id="rpress-logs-filter" method="get" action="admin.php">
